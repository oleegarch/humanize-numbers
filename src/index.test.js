...
describe('humanizeNumber', () => {
	...
	it('with options', () => {
		...
		expect(humanizeNumberXS(500, { withUnit: 1e3 })).toBe('0.5К')
		expect(humanizeNumberXS(1e9, { withUnit: 1e3 })).toBe('1ККК')
		expect(humanizeNumberXS(1e12, { withUnit: 1e3 })).toBe('1КККК')
		expect(humanizeNumberXS(1e12, { withUnit: 1e6 })).toBe('1ММ')
...
describe('textToNumbers', () => {
	...
	it('abbr ru', () => {
		...
		expect(textToNumbers('1B')).toEqual({ numbers: [1000000000], textWithoutNumbers: '' })
		expect(textToNumbers('1Т')).toEqual({ numbers: [1000000000000], textWithoutNumbers: '' })
	})
	it('full text', () => {
